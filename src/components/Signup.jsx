...
function Signup() {
    ...
    return (
        <div className="flex items-center justify-center">
            <div className={`mx-auto w-[80%] max-w-lg bg-gray-100 rounded-xl py-10 px-5 sm:py-11`}>
                ...
                <p className="mt-2 mb-4 sm:mb-0 text-center text-md text-black/60">
                ...
                <form onSubmit={handleSubmit(create)}>
                    <div className='space-y-5'>
                        ...
                        {loading ? (<div className='w-full flex flex-row justify-center'>
